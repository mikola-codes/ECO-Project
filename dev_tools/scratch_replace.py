...
filepath = r"C:\Users\Librero Kevin Trazie\OneDrive\Desktop\ECO-Project\admin.html"

with open(filepath, "r", encoding="utf-8") as f:
    content = f.read()

# Extract JS part
js_part_match = re.search(r'(<script src="assets/js/bootstrap\.bundle\.min\.js"></script>.*)', content, re.DOTALL)
if not js_part_match:
    js_part_match = re.search(r'(<script src="libs/bootstrap\.bundle\.min\.js"></script>.*)', content, re.DOTALL)

if not js_part_match:
    print("Could not find JS part")
    exit(1)

js_part = js_part_match.group(1)
...
print("admin.html has been rewritten successfully, preserving scripts.")
